  ...
  return (
    <>
      ...
      <main className="relative min-h-screen overflow-x-hidden bg-linear-to-b from-white to-slate-50 pt-16 pb-24 text-slate-900">
        ...
        <div
          className="pointer-events-none absolute top-40 left-1/4 -z-10 h-72 w-72 rounded-full bg-blue-600/[0.07] blur-3xl"
          aria-hidden
        />
        <div
          className="pointer-events-none absolute right-1/4 bottom-24 -z-10 h-80 w-80 rounded-full bg-slate-400/6 blur-3xl"
          aria-hidden
        />
        ...
        >
          ...
          <div className="relative z-1 w-full max-w-3xl space-y-10 text-center">
            ...
            >
              <div
                className="pointer-events-none absolute -inset-6 rounded-4xl bg-blue-600/10 blur-3xl"
                aria-hidden
              />
                ...
                <Fragment key={step.title}>
                  ...
                  {i < 2 && (
                    <div
                      ...
                      aria-hidden
                    >
                      <div className="h-px w-full min-w-10 border-t border-dashed border-slate-200/90 lg:min-w-16" />
                    </div>
                  )}
                </Fragment>
              ))}
        ...
        {/* FAQ Section */}
        <section
          className="border-t border-slate-200/60 bg-slate-50/50 px-4 py-16"
          aria-labelledby="faq-heading"
        >
          <div className="mx-auto max-w-4xl">
            <h2
              id="faq-heading"
              className="mb-8 text-center text-2xl font-semibold tracking-tight text-slate-900 md:text-3xl"
            >
              {currentFaq.faqTitle}
            </h2>
            <div className="space-y-4">
              {currentFaq.questions.map((faq, index) => (
                <details
                  key={index}
                  className="group rounded-xl border border-slate-200/60 bg-white shadow-sm"
                >
                  ...
                  <p className="px-4 pb-4 leading-relaxed text-slate-600">{faq.a}</p>
                </details>
              ))}
            </div>
          </div>

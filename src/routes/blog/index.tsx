...
export const Route = createFileRoute('/blog/')({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: 'description',
        content: 'Læs vores guides og artikler om bilvurdering. Lær hvad din bil er værd og hvordan du får den bedste pris.',
      },
      {
        property: 'og:title',
...
const blogPostsDa = [
  ...
  },
  {
    ...
    excerpt: 'Lær hvordan du selv kan vurdere din bils værdi ved at analysere markedet og tage højde for vigtige faktorer.',
    date: '9. april 2026',
    readTime: '4 min',
  },
  {
    ...
    excerpt: 'Få praktiske tips til at maksimere salgsprisen på din bil - fra rengøring til forhandling.',
    date: '9. april 2026',
    readTime: '6 min',
  },
]
...
const blogPostsEn = [
  {
    ...
    excerpt: 'Want to know what your car is worth? Read our complete guide to car valuation and learn how to get the best price.',
    date: 'April 9, 2026',
    readTime: '5 min',
  },
]
          ...
          >
            <Link to={`/blog/${post.slug}`} className="block">
              <div className="mb-3 flex items-center gap-4 text-sm text-slate-500">
                <span>{post.date}</span>
                <span>•</span>
                <span>{post.readTime} {language === 'da' ? 'læsetid' : 'read'}</span>
              </div>

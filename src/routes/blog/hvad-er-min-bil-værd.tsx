...
function HvadErMinBilVaerd() {
    ...
    return (
      <>
        ...
        <BlogArticleLayout
          ...
          language={language}
        >
          <div className="my-8 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 p-8 text-white text-center">
            <p className="text-lg text-blue-100 mb-2">Most cars lose</p>
          ...
          <Step number={1} title="Understand Depreciation">
            <p className="text-slate-600 mb-4">Cars lose value over time. Here's the typical pattern:</p>
            ...
            <InfoBox title="Good to know" color="green">
              Electric cars and luxury vehicles may have different depreciation curves. EVs often hold value better due to high demand.
            </InfoBox>
          </Step>

          <Step number={2} title="Brand & Model Matter">
            <p className="text-slate-600 mb-4">Some brands hold value better than others:</p>
          ...
          <Step number={3} title="Mileage Impact">
            <p className="text-slate-600 mb-4">Every kilometer affects value. Here's how much:</p>
          ...
          <Step number={4} title="Equipment Adds Value">
            <p className="text-slate-600 mb-4">Popular features that increase value:</p>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {[
                ...
                <div key={feature.item} className="flex items-center justify-between rounded-lg bg-slate-50 p-3">
          ...
          <Step number={5} title="Get Your Valuation">
            <p className="text-slate-600 mb-4">The easiest way to know your car's value:</p>
              ...
              <ol className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-center gap-3 text-slate-700">
                    <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-blue-600 text-sm font-bold text-white">{i + 1}</span>
                    {step}
                  </li>
                ))}
              </ol>
  ...
  return (
    <>
      ...
      >
        <div className="my-8 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 p-8 text-white text-center">
          <p className="text-lg text-blue-100 mb-2">De fleste biler mister</p>
          <p className="text-4xl font-bold mb-2">15-20%</p>
          <p className="text-blue-100">af værdien det første år</p>
        </div>

        <Step number={1} title="Forstå værditabet">
          <p className="text-slate-600 mb-4">Biler mister værdi over tid. Sådan ser mønsteret typisk ud:</p>
          ...
          <InfoBox title="Godt at vide" color="green">
            Elbiler og luksusbiler kan have anderledes afskrivningskurver. Elbiler holder typisk bedre på værdien pga. høj efterspørgsel.
          </InfoBox>
        </Step>

        <Step number={2} title="Mærke & model betyder noget">
          <p className="text-slate-600 mb-4">Nogle mærker holder bedre på værdien end andre:</p>
        ...
        <Step number={3} title="Kilometerstandens betydning">
          <p className="text-slate-600 mb-4">Hver kilometer påvirker værdien. Så meget betyder det:</p>
        ...
        <Step number={4} title="Udstyr giver mere værdi">
          <p className="text-slate-600 mb-4">Populære features der øger værdien:</p>
        ...
        <Step number={5} title="Få din vurdering">
          <p className="text-slate-600 mb-4">Den nemmeste måde at kende din bils værdi:</p>
        ...
        <div className="mt-12">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Link to="/blog/bil-vurdering-guide" className="group flex items-center gap-4 rounded-xl border border-slate-200 p-4 transition-colors hover:border-blue-300 hover:bg-blue-50/50">
              ...
              <div>
                <h4 className="font-semibold text-slate-900 group-hover:text-blue-600">Sådan vurderer du selv</h4>

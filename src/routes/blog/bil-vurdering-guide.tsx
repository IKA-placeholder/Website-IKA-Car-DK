...
function CalculationBox({ children }: { children: React.ReactNode }) {
  return (
    <div className="my-4 rounded-xl bg-slate-900 p-4 font-mono text-sm text-white">
      {children}
    </div>
  )
}
    ...
    return (
      <>
        ...
        <BlogArticleLayout
          ...
          language={language}
        >
          <div className="my-8 rounded-2xl bg-amber-50 border-2 border-amber-200 p-6">
            <div className="flex items-start gap-3">
              <svg className="h-6 w-6 text-amber-600 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
              </svg>
              <div>
                <h4 className="font-semibold text-amber-900">Why do it yourself?</h4>
                <p className="text-amber-800">Understanding your car's value helps you negotiate better and avoid accepting low offers.</p>
              </div>
            </div>
          </div>

          <Step number={1} title="Find Similar Cars">
            <p className="text-slate-600 mb-4">Search for cars like yours on these platforms:</p>
            ...
            <div className="mt-4 rounded-xl bg-blue-50 p-4">
              <p className="text-blue-900"><strong>Tip:</strong> Look at 5-10 similar cars to get a good price range.</p>
            </div>
          </Step>

          <Step number={2} title="What to Compare">
            <p className="text-slate-600 mb-4">Make sure you're comparing apples to apples:</p>
          ...
          <Step number={3} title="Calculate the Base Price">
            <p className="text-slate-600 mb-4">Take the average of the prices you found:</p>
            
            <CalculationBox>
              <p className="text-slate-400">Base Price =</p>
              <p>(Price 1 + Price 2 + Price 3 + ... + Price N) ÷ N</p>
              <p className="mt-2 text-slate-400">Example: (180k + 185k + 175k + 182k + 178k) ÷ 5 = 180,000 kr.</p>
            </CalculationBox>
          </Step>

          <Step number={4} title="Adjust for Mileage">
            <p className="text-slate-600 mb-4">Higher mileage means lower value:</p>
          ...
          <Step number={5} title="Add Equipment Value">
            <p className="text-slate-600 mb-4">Extra features add to the value:</p>
          ...
          <Step number={6} title="Adjust for Condition">
            <p className="text-slate-600 mb-4">Your car's condition affects price:</p>
          ...
          <div className="my-8 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-700 p-8 text-white">
            ...
            <p className="mt-4 text-blue-100">Always add 5-10% to your minimum price so you have room to negotiate.</p>
          </div>

          <div className="mt-8 rounded-2xl bg-green-500 p-6 text-white text-center">
            <p className="text-lg mb-2">Want an instant valuation?</p>
            <p className="text-green-100 mb-4">Get market-based price in 10 seconds</p>
            <Link 
              to="/" 
    ...
    <>
      ...
      >
        <div className="my-8 rounded-2xl bg-amber-50 border-2 border-amber-200 p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-amber-800">At forstå din bils værdi hjælper dig med at forhandle bedre og undgå at acceptere for lave bud.</p>
            </div>
          </div>
        </div>

        <Step number={1} title="Find lignende biler">
          <p className="text-slate-600 mb-4">Søg efter biler som din på disse platforme:</p>
          ...
          <div className="mt-4 rounded-xl bg-blue-50 p-4">
            <p className="text-blue-900"><strong>Tip:</strong> Kig på 5-10 lignende biler for at få et godt prisspænd.</p>
          </div>
        </Step>

        <Step number={2} title="Hvad skal du sammenligne">
          <p className="text-slate-600 mb-4">Sørg for at sammenligne æbler med æbler:</p>
        ...
        <Step number={3} title="Beregn basisprisen">
          <p className="text-slate-600 mb-4">Tag gennemsnittet af de priser du har fundet:</p>
          
          <CalculationBox>
            <p className="text-slate-400">Basispris =</p>
            <p>(Pris 1 + Pris 2 + Pris 3 + ... + Pris N) ÷ N</p>
            <p className="mt-2 text-slate-400">Eksempel: (180k + 185k + 175k + 182k + 178k) ÷ 5 = 180.000 kr.</p>
          </CalculationBox>
        </Step>

        <Step number={4} title="Juster for kilometer">
          <p className="text-slate-600 mb-4">Højere km-stand betyder lavere værdi:</p>
        ...
        <Step number={5} title="Læg udstyr til">
          <p className="text-slate-600 mb-4">Ekstraudstyr giver mere værdi:</p>
        ...
        <Step number={6} title="Juster for stand">
          <p className="text-slate-600 mb-4">Din bils stand påvirker prisen:</p>
        ...
        <div className="my-8 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-700 p-8 text-white">
          ...
          <p className="mt-4 text-blue-100">Læg altid 5-10% oveni din minimumspris, så du har plads til at forhandle.</p>
        </div>

        <div className="mt-8 rounded-2xl bg-green-500 p-6 text-white text-center">
          <p className="text-lg mb-2">Vil du have en hurtig vurdering?</p>
          <p className="text-green-100 mb-4">Få markedspris på 10 sekunder</p>
          <Link 
            to="/" 
            className="inline-flex items-center rounded-lg bg-white px-6 py-3 font-bold text-green-600 transition-transform hover:scale-105"
          >
        ...
        <div className="mt-12">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Link to="/blog/hvad-er-min-bil-værd" className="group flex items-center gap-4 rounded-xl border border-slate-200 p-4 transition-colors hover:border-blue-300 hover:bg-blue-50/50">
              ...
              <div>
                <h4 className="font-semibold text-slate-900 group-hover:text-blue-600">Hvad er min bil værd?</h4>
                <p className="text-sm text-slate-600">Komplet guide til bilværdi</p>
              </div>
            </Link>
            <Link to="/blog/saelg-bil-hoejeste-pris" className="group flex items-center gap-4 rounded-xl border border-slate-200 p-4 transition-colors hover:border-blue-300 hover:bg-blue-50/50">
              ...
              <div>
                <h4 className="font-semibold text-slate-900 group-hover:text-blue-600">Få højeste pris</h4>
